...
import com.clangpp.sunshine.MainActivity;
import com.clangpp.sunshine.R;
import com.clangpp.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static Account getSyncAccount(Context context) {
        ...
        Account newAccount = new Account(
                context.getString(R.string.app_name),  // dummy name, meaningless
    ...
    public void onPerformSync(
        ...
        updateWeatherFromServer(location, provider);
        notifyWeather();
    }

    public void updateWeatherFromServer(String location, ContentProviderClient provider) {
        ...
        try {
            getWeatherDataFromJson(forecastJsonStr, locationQuery, numDays);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting, int numDays)
        ...
        if (cVVector.size() > 0) {
            ...
            String yesterdayDbString = WeatherContract.getDbDateString(calendar.getTime());
            getContext().getContentResolver().delete(
                    WeatherEntry.CONTENT_URI,
                    WeatherEntry.COLUMN_DATETEXT + "<=?",
                    new String[]{yesterdayDbString}
            );
        }
    }

    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        final String LOCATION_SELECTION = WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING +
                "=" + locationSetting;
    ...
    private void notifyWeather() {
        ...
        boolean notificationEnabled = prefs.getBoolean(
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                int iconId = WeatherContract.getIconResourceForWeatherCondition(weatherId);
